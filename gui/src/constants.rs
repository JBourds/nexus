...
pub const SEQ_DOT_RADIUS: f32 = 5.0;
pub const SEQ_DOT_RADIUS_CURRENT: f32 = 7.0;
pub const SEQ_SELECTION_RING_RADIUS: f32 = 10.0;
pub const SEQ_SELECTION_RING_STROKE: f32 = 2.0;
