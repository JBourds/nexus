...
pub fn parse(text: String) -> Result<raw::Simulation> {
...
//             queue_delay: DistanceVar::default(),
//             processing_delay: DistanceVar::default(),
//             connection_delay: DistanceVar::default(),
//             propagation_delay: DistanceVar::default(),
//         }
//     }
// }
//
